defmodule SensorHub.Homekit.TemperatureSensor do
  ...
  def handle_call({:get, sensor: sensor}, _from, state) do
    ["environment", %{ temperature_c: temperature }] = sensor.read.() |> sensor.convert.()

    Logger.info("Returning value of #{temperature}")

    {:reply, {:ok, temperature}, state}
  end
