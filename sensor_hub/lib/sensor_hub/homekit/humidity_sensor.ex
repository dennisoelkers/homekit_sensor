defmodule SensorHub.Homekit.HumiditySensor do
  ...
  def handle_call({:get, sensor: sensor}, _from, state) do
    ["environment", %{ humidity_rh: humidity }] = sensor.read.() |> sensor.convert.()

    Logger.info("Returning value of #{humidity}")

    {:reply, {:ok, humidity}, state}
  end
